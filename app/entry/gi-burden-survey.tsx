...
const QUESTIONS = [
  'I experienced nausea or vomiting this week.',
  'I had stomach discomfort, pain, or cramping.',
  'I felt constipated or had difficulty with bowel movements.',
  'GI symptoms forced me to skip meals or limit what I ate.',
  'Stomach issues disrupted my daily routine or sleep.',
] as const;
...
export default function GiBurdenSurveyScreen() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      await addWeeklyCheckin('gi_burden', answersMap, score100);
      router.replace({
    ...
    <View style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      >
        ...
        <View style={{ alignItems: 'center' }}>
          <Text style={{ fontSize: 20, fontWeight: '800', color: colors.textPrimary }}>GI Symptom Check-In</Text>
      ...
      >
          ...
          <View style={{ padding: 20, alignItems: 'center' }}>
            ...
            <View style={[s.badge, { backgroundColor: `${interpretation.color}22`, marginTop: 10 }]}>
              <Text style={{ fontSize: 15, fontWeight: '700', color: interpretation.color, letterSpacing: 0.5 }}>
                {interpretation.label} GI Burden
              </Text>
            </View>
          </View>
        </View>
        ...
        <Text style={{ fontSize: 14, color: colors.textMuted, textAlign: 'center', marginTop: 8, lineHeight: 17 }}>
          Answer for this past week. Your GI score helps adjust calorie and activity targets automatically.
        </Text>
      </ScrollView>
