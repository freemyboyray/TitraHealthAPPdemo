    ...
    <View style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      >
        ...
        <View style={{ alignItems: 'center' }}>
          <Text style={{ fontSize: 18, fontWeight: '800', color: colors.textPrimary }}>Mental Health Check-In</Text>
      ...
      >
        ...
        {showProviderPrompt && (
          ...
          >
            ...
            <Text style={{ flex: 1, fontSize: 13, color: colors.textPrimary, lineHeight: 18 }}>
        ...
        <Text style={{ fontSize: 11, color: colors.textMuted, textAlign: 'center', marginTop: 8, lineHeight: 16 }}>
