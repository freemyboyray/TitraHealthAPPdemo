    ...
    <View style={{ flex: 1, backgroundColor: BG }}>
      ...
      >
        ...
        <View style={{ alignItems: 'center' }}>
          <Text style={{ fontSize: 18, fontWeight: '800', color: '#FFFFFF' }}>Food Noise Check-In</Text>
      ...
      >
        ...
        <View style={[s.card, { marginBottom: 16 }]}>
          ...
          <View style={{ padding: 20, alignItems: 'center' }}>
            ...
            {lowNoiseMessage && (
              <Text style={{ fontSize: 13, color: 'rgba(255,255,255,0.5)', textAlign: 'center', marginTop: 10, lineHeight: 18 }}>
                {lowNoiseMessage}
              </Text>
            )}
          </View>
