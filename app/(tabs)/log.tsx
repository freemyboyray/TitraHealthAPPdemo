...
const LIFESTYLE_LOGS: LogEntry[] = [
  ...
  },
  {
    ...
    icon: <Ionicons name="water-outline" size={18} color={ORANGE} />,
  },
];
...
function WeightTimelineCard() {
  const milestones = [
    { color: '#FFFFFF', label: 'Starting Weight', date: 'Oct 15, 2024', weight: '220 lbs', muted: false },
    { color: ORANGE, label: 'Current Weight', date: 'Mar 5, 2026', weight: '195 lbs', muted: false },
    { color: '#3A3735', label: 'Est. Goal Weight', date: 'Jun 2026', weight: '~180 lbs', muted: true },
  ];
          ...
          {activeTab === 'lifestyle' && (
            <>
              ...
              <View style={s.metricsRow}>
                ...
                <MetricCard value="8,432" label="Daily Steps" ringColor="#FFFFFF" />
              </View>
