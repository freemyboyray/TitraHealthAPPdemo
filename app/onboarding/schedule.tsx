...
const createStyles = (c: AppColors) => StyleSheet.create({
  ...
  input:        {
    ...
    paddingHorizontal: 16, fontSize: 16, fontFamily: 'Inter_400Regular', color: c.textPrimary,
    marginTop: 4, marginBottom: 10, backgroundColor: c.bg,
  },
  sectionLabel: { fontSize: 16, fontWeight: '600', fontFamily: 'Inter_400Regular', color: c.textPrimary, marginTop: 24, marginBottom: 12 },
  ...
  tipTitle:     { fontSize: 14, fontWeight: '700', color: '#FF742A', marginBottom: 8, fontFamily: 'Inter_700Bold' },
  tipBody:      { fontSize: 13, color: c.textSecondary, lineHeight: 20, fontFamily: 'Inter_400Regular' },
