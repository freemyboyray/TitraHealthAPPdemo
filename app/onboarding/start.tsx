...
const createStyles = (c: AppColors) => StyleSheet.create({
  ...
  rowLabel: { fontSize: 18, fontWeight: '600', color: c.textPrimary, fontFamily: 'System' },
  rowRight: { flexDirection: 'row', alignItems: 'center' },
  rowValue: { fontSize: 18, color: c.textSecondary, fontFamily: 'System' },
  inlineInput: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  inputText: { fontSize: 20, color: c.textPrimary, minWidth: 80, textAlign: 'right', fontFamily: 'System' },
  unitHint: { fontSize: 16, color: c.textSecondary, fontFamily: 'System' },
});
