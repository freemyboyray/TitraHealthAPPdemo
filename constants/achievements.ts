...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  // Weight
  { id: 'w5',   name: 'First 5',         label: '5 lbs',    icon: 'trending-down',    category: 'weight',    threshold: 5,   description: "Your first 5 lbs lost" },
  { id: 'w10',  name: 'Double Digits',   label: '10 lbs',   icon: 'trending-down',    category: 'weight',    threshold: 10,  description: "Double digits \u2014 10 lbs lost" },
  ...
  // Treatment
  { id: 't7',   name: 'Getting Started', label: '1 week',   icon: 'medical',          category: 'treatment', threshold: 7,   description: "Your first week on treatment" },
  { id: 't30',  name: 'One Month In',    label: '30 days',  icon: 'medical',          category: 'treatment', threshold: 30,  description: "One month on your treatment plan" },
  { id: 't90',  name: 'Committed',       label: '3 months', icon: 'shield-checkmark', category: 'treatment', threshold: 90,  description: "Three months of commitment" },
  { id: 't180', name: 'Half Year',       label: '6 months', icon: 'shield-checkmark', category: 'treatment', threshold: 180, description: "Six months on treatment" },
...
/** Category → accent color for achievement UI. */
export const ACHIEVEMENT_ACCENT: Record<Achievement['category'], string> = {
  streak: '#FF742A',
  weight: '#34C759',
  treatment: '#5AC8FA',
};
