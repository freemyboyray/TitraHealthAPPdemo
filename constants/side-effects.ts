...
export const SIDE_EFFECTS: SideEffectDef[] = [
  ...
  { id: 'heartburn',       label: 'Heartburn',         category: 'digestive', defaultEnabled: true,  dbType: 'other' },
  ...
  { id: 'bloating',        label: 'Bloating',          category: 'digestive', defaultEnabled: false, dbType: 'other' },
  { id: 'sulfur_burps',    label: 'Sulfur Burps',      category: 'digestive', defaultEnabled: false, dbType: 'other' },
  ...
  // Appetite
  { id: 'food_noise',          label: 'Food Noise',          category: 'appetite', defaultEnabled: true, dbType: 'appetite_loss' },
  ...
  { id: 'dizziness',        label: 'Dizziness',        category: 'physical', defaultEnabled: false, dbType: 'other' },
